                    ...
                    <div className="text-white lg:w-1/2 lg:mx-6">
                        ...
                        <div className="mt-6 space-y-8 md:mt-8">
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-white  w-72">
                                    3rd Floor, MCA Lodge,
                                    Musan Saw Gali, Korrah,
                                    Near Bhadarkali Lodge,
                                    Hazaribagh - 825301,
                                    Jharkhand, India
                                </span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <a href="tel:+916203700026" className="mx-2 text-white truncate w-72">+91 6203700026</a>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <a href="mailto:acb@example.com" className="mx-2 text-white truncate w-72">devamit342@gmail.com</a>                            </p>
                        </div>
                        ...
                        <div className="mt-6 md:mt-8">
                            ...
                            <div className="flex mt-4 -mx-1.5 ">
                                <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-cyan-500" href="https://twitter.com/AmitKrVr">
                                ...
                                <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-cyan-500" href="https://www.linkedin.com/in/amitkrvr/">
                                ...
                                <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-cyan-500" href="https://github.com/AmitKrVr">
                                    <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-cyan-500" href="https://www.instagram.com/AmitKrVr">
                                    <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <form onSubmit={handleSubmit} className="mt-4">
                                <div className="flex-1">
                                    ...
                                    <input
                                        ...
                                        className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-400 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-cyan-400 focus:ring-cyan-300 focus:ring-opacity-40 dark:focus:border-cyan-300 focus:outline-none focus:ring" />
                                </div>
                                ...
                                <div className="flex-1 mt-6">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        required
                                        placeholder="johndoe@example.com" className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-400 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-cyan-400 focus:ring-cyan-300 focus:ring-opacity-40 dark:focus:border-cyan-300 focus:outline-none focus:ring" />
                                </div>
                                ...
                                <div className="w-full mt-6">
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        required
                                        className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-400 rounded-md md:h-48 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-cyan-400 focus:ring-cyan-300 focus:ring-opacity-40 dark:focus:border-cyan-300 focus:outline-none focus:ring" placeholder="Message"></textarea>
                                </div>

                                <button
                                    type="submit"
                                    className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-cyan-600 rounded-md hover:bg-cyan-500">
                                    get in touch
                                </button>
                            </form>
                        </div>
