            ...
            <div className="flex flex-col h-full items-center justify-center antialiased">
                ...
                <div className="max-w-4xl mx-auto p-4 space-y-4">
                    ...
                    <p className="text-neutral-500 max-w-3xl mx-auto my-2 text-base text-center relative z-10">
                        At TechNova Solutions, we believe in the transformative power of technology to drive business success. Our mission is to empower your business by leveraging the latest advancements in technology and delivering exceptional, personalized service.
                    </p>
                    <div className="flex justify-center">
                        <button className="relative z-10 inline-flex h-12 overflow-hidden rounded-full p-[1px]">
                            <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#267594_0%,#03f2ff_50%,#267594_100%)]" />
